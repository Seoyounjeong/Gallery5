...
<label for="gallery_img1"><button onclick="imgup(1)">파일추가</button></label>
...
<label for="gallery_img2"><button onclick="imgup(2)">파일추가</button></label>
...
<label for="gallery_img3"><button onclick="imgup(3)">파일추가</button></label>
...
<label for="gallery_img4"><button onclick="imgup(4)">파일추가</button></label>
<input style="display: none;" onchange="imageURL(this)" id="gallery_img4" multiple="multiple" type="file" name="file" required="required">
</div>
...
<div id="Gallery_setion2" style="display: none;">
...
<caption>
<a href="selectGallery.do?year=<%=year-1%>&month=<%=month%>&g_no=${galleryDto.g_no}">◁</a>
<a href="selectGallery.do?year=<%=year%>&month=<%=month-1%>&g_no=${galleryDto.g_no}">◀</a>
